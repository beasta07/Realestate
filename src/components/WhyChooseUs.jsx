...
const WhyChooseUs = () => {
  return (
    ...
    <div className="sm:flex sm:gap-[10] mt-[8rem] container w-[100%] mx-auto p-3 sm:p-0  ">
      <div className="">
        <img src="images/WhyChooseUs.jpg" className="rounded-lg w-[50rem] sm:mt-[4rem] mb-[8rem]" />
      </div>
      <div className="sm:ml-[7rem] sm:mt-[7rem] mt-[4rem]"> 
      <div>
        <h1 className="font-semibold text-[2rem]">Why Choose Us</h1>
        <p className="sm:w-[70%]">As the complexity of buildings to increase, the
field of architecture.</p>
</div>
...
<div>
    ...
    <p className="">Nullam sollicitudin blandit eros eu pretium. Nullam maximus ultricies auctor.</p>
</div></div>
