    ...
    return (
        <div>
            <div className="rounded-lg shadow inline-block overflow-hidden sm:ml-[1rem]">
                    <img src={`https://api.myraj.au/${property.images[0]}`} className="rounded-t-lg hover:scale-105 sm:h-[15rem] sm:w-[23rem] w-[20rem] h-[12rem] transition duration-500 cursor-pointer object-cover" />
