...
const RealEstate = () => {
  return (
    <div className="bg-[#FEF7F6]">
      <div className="flex justify-between container w-[100%] mx-auto mt-[5rem]  p-3 sm:p-0 ">
        <div className="pt-[5rem]">
            ...
            <button className="text-[white] rounded-md bg-[#EB6753] w-[12rem] p-3 font-semibold  mb-[5.6rem]">Register Now</button>
        </div>
        <div>
