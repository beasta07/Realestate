...
const Footer = () => {
    return (
        <div className="bg-[#181B21] w-[100%] mt-[9rem]">
            ...
            <div className="container w-[100%] mx-auto sm:flex justify-between px-5 pt-16 sm:px-14 mt-[4rem] text-white">
                <div className="pb-12 sm:pb-0"> 
                    <h2 className="font-semibold text-[1.5rem] pb-8 text-orange-600">Homez</h2>
                    ...
                    <p className="font-medium">hello@homez.com</p>
                </div>
                <div className="pb-12 sm:pb-0">
                ...
                <hr className="h-px bg-gray-200 border-0 sm:w-[75%] mx-auto dark:bg-gray-700 mt-10" />

            <div className="container w-[100%] mx-auto sm:flex text-white justify-between px-5 sm:px-12 py-8">
                <div>
