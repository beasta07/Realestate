    ...
    return (
        <div className="px-3 sm:px-0">
            <div className=" mx-auto px-8 sm:px-4 sm:w-[23rem] rounded-lg py-[2rem] bg-white mt-9">
                ...
                <button
                    className="flex py-3 px-[5.8rem] sm:px-[7.4rem] transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-400 mt-8 rounded-lg text-[1.1rem] text-white"
