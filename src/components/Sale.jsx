...
const Sale = ({ property }) => {
  ...
  return (
    <div className="pb-5  ">
      <div className="bg-white sm:w-[100%]  h-[22rem] transition duration-300 ease-in-out hover:scale-110  sm:h-[20rem] rounded-xl">
        <img className="rounded-t-xl h-[12rem] w-[100%]  " src={imageUrl} />
        <h2 className="font-bold mt-5 ml-4 line-clamp-1  " alt="Louvre" >{property?.name}</h2>
