        ...
        <div className="flex text-black bg-white gap-9 px-6 py-5 rounded-t-xl w-[62%] sm:w-[19%]">
          <button
            ...
            className={`font-medium ${
              selectedButton === 'Buy' ? 'border-b-2 border-black py-2' : 'border-none'
            }`}
          >
            Buy
          </button>
          <button
            ...
            className={`font-medium ${
              selectedButton === 'Rent' ? 'border-b-2 border-black py-2 transition' : 'border-none'
            }`}
          >
            Rent
          </button>
          <button
            ...
            className={`font-medium ${
              selectedButton === 'Sold' ? 'border-b-2 border-black py-2 transition' : 'border-none'
            }`}
          >
            Sold
          </button>
