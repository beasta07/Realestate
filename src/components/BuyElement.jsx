      ...
      <div className="container w-[100%] mx-auto mt-[4rem] leading-[3rem]">
        <div className="sm:flex justify-between sm:px-0 px-1">
          <div>
            ...
            <p>{property?.location.district},{property.location.tole}</p>
            <div className="flex ">
        ...
        <div className="sm:flex justify-between sm:px-[2rem] px-1 sm:mt-[2rem]">
          ...
          <div className="flex">
            <div className="bg-transparent  mr-5 :border-black "><MdOutlineGarage className="p-3 border-2 text-[3.5rem] rounded-md" /></div>
            <div>
