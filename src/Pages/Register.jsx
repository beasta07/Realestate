...
import { postRegister, clearError } from "../Redux/features/authSlice";
...
const Register = () => {
  ...
  return (
    <div className="pb-9 container sm:w-[50%] mx-auto">
      ...
      <h2 className="text-center mt-9 font-semibold text-[1.4rem] text-orange-600">
        ...
        >
          <Form className="mt-5 gap-4 grid grid-cols-2">
            ...
            <div className="col-span-2 w-[100%] py-6">
              <button
                type="submit"
                className="transition duration-300 text-white text-[1.2rem] font-semibold py-4 rounded-xl bg-orange-600 w-full"
              >
                <h2 className="flex sm:mx-[13.2rem]">
                  {" "}
                  <VscAccount className="mt-1 sm:mr-2 sm:ml-0 ml-24" /> Register
                  Account
                </h2>
              </button>
            </div>
