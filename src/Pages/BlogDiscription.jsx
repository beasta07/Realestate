    ...
    <div>
      <div>
        <div className="container w-[100%] mx-auto my-[4rem] px-3 sm:px-0">
          <h2 className="sm:text-[2rem] text-[1.3rem] font-semibold">
            {blog?.title}
          </h2>
          <div className="flex gap-5 divide-x-2 mt-4">
            ...
            <div>
              <p className="pl-0">January 30, 2024</p>
            </div>
          </div>
        </div>
        <div>
          <img src="/image/BlogDiscImg1.jpg" className="w-[100%]" />
        </div>
        <div className="container sm:w-[53%] px-3 sm:px-0 mx-auto">
          ...
          <div>
            ...
            <div>
              <img
                src={`https://api.myraj.au/${blog?.images[1].replace(
                  "public/",
                  ""
                )}`}
                className="rounded-lg mt-[3.5rem]"
              />
            </div>
            <div>
              <h2 className="font-medium text-[1.3rem] pt-12 pb-5">
