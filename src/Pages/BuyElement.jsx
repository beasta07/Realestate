      ...
      <div className="container w-[100%] mx-auto mt-[4rem] leading-[3rem]">
        <div className="sm:flex justify-between sm:px-0 px-1">
          ...
          <div>
            <div className="flex leading-[3rem]">
              <div className="border-2 bg-transparent p-2 mr-2 rounded-md hover:border-black h-9">
                <CiHeart />
              </div>
              <div className="border-2 bg-transparent p-2 mr-2 rounded-md hover:border-black h-9">
                <BsCopy />
              ...
              <div className="border-2 bg-transparent p-2 rounded-md hover:border-black h-9">
                <IoPrintOutline />
              </div>
            </div>
            <p className="font-semibold text-[1.5rem] sm:text-right mt-3">
              {property.price}
            </p>
        ...
        <div className="sm:grid grid-rows-2 grid-flow-col gap-4 mt-[4rem] mb-[4rem] sm:mb-0">
          <div className="row-span-3 ...">
            <img
              src={`https://api.myraj.au/${property.images[0]}`}
              className="rounded-l-xl hover:scale-105 h-[34rem] w-[50rem] transition-transform duration-300"
            />
          </div>
          <div className="col-span-2 ...">
            <img
              src={`https://api.myraj.au/${property.images[1]}`}
              className="hidden sm:block rounded-r-xl hover:scale-105 transition-transform duration-300"
            />
          </div>
          <div className=" col-span-2 ...">
            <img
        ...
        <div className="sm:flex justify-between sm:px-[2rem] px-1 ">
          <div className="flex">
            <div className="bg-transparent  mr-5 hover:border-black ">
              <FaBed className="p-3 border-2 text-[3.5rem] rounded-md" />
            </div>
            <div>
          ...
          <div className="flex">
            <div className="bg-transparent  mr-5 hover:border-black ">
              <FaShower className="p-3 border-2 text-[3.5rem] rounded-md" />
            </div>
            <div>
          ...
          <div className="flex">
            <div className="bg-transparent  mr-5 hover:border-black ">
              <SlCalender className="p-3 border-2 text-[3.5rem] rounded-md" />
            </div>
            <div>
          ...
          <div className="flex">
            <div className="bg-transparent  mr-5 hover:border-black ">
              <MdOutlineGarage className="p-3 border-2 text-[3.5rem] rounded-md" />
            </div>
            <div>
          ...
          <div className="flex">
            <div className="bg-transparent  mr-5 hover:border-black ">
              <RiPinDistanceFill className="p-3 border-2 text-[3.5rem] rounded-md" />
            </div>
            <div>
      ...
      <div className="bg-[#F7F7F7] mt-[4rem]">
        <div className="container w-[100%] mx-auto pb-16">
          <div className="sm:flex p-5">
            <div className="sm:w-[70%]  sm:px-0 rounded-xl shadow-md bg-white mt-[4rem] sm:h-[35rem]">
              ...
              {showMore && (
                <p className="mx-5 text-[0.85rem] text-justify leading-[1.5rem]">
                  ...
                  demonstrate the class. This is the first items accordion body
                  you get groundbreaking performance and amazing battery life.
                  Add to that a stunning Liquid Retina XDR display, the best
                  camera and audio ever in a Mac notebook, and all the ports you
                  need.
                </p>
              )}
              <button
                onClick={toggleShowMore}
                className="text-black font-semibold hover:underline focus:outline-none text-[1rem] mx-5"
              >
                {showMore ? "Show Less" : "Show More"}
              </button>

              <div className="p-5 pb-3 justify-content-between">
                <h1 className="font-semibold text-[1.25rem] my-[2rem]">
                  Property Details
                </h1>
                <div className="sm:flex gap-[4rem]">
                  <div>
                    ...
                    <div className="flex gap-[2rem] pb-3">
                      <h1 className="font-semibold mr-[6rem]">Bathroom</h1>
                  ...
                  <div>
                    <div className="flex gap-[2rem] pb-3">
                      <h1 className="font-semibold mr-[4.7rem]">
                        Property Type
                      </h1>
                      <p>Apartment</p>
                    </div>
                    <div className="flex gap-[2rem] pb-3">
                      <h1 className="font-semibold mr-[4rem]">
                        Property Status
                      </h1>
            ...
            <div className="w-[30%] rounded-xl shadow-md bg-white mt-[4rem] ml-[2rem] sm:block hidden">
              <div className="flex mt-5 pl-7">
                <img
                  src="/public/images/reviewImage01.jpg"
                  className="w-[5rem]"
                />
                <div className="ml-4">
                  <h1 className="font-semibold text-[0.85rem] mb-2">
                    Leslie Alexander
                  </h1>
              ...
              <div className="pl-5 h-[25rem]">
                ...
                <label className="text-[0.85rem]">
                  {" "}
                  i agree to Terms and conditions on this.
                </label>
                <button className="text-[white] rounded-md bg-[#EB6753] w-[12rem] p-3 font-semibold hidden sm:block mb-[5.6rem] mt-4 mx-auto">
                  Register Now
                </button>
              </div>
            </div>
          ...
          <div className="sm:w-[66%] rounded-xl px-1 sm:px-0 shadow-md bg-white mt-[rem] ml-5 ">
            ...
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14134.395666697252!2d85.32008!3d27.6678783!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb19c82b81d77d%3A0x879326313b815595!2sApp%20Technologies%20Pvt.%20Ltd.!5e0!3m2!1sen!2snp!4v1706590703142!5m2!1sen!2snp"
              width="100%"
              height="300"
              style={{ border: 0 }}
              allowfullscreen=""
              loading="lazy"
              className=" p-4 rounded-lg pb-5  sm:w-[100%]  "
            ></iframe>
          </div>
        </div>
      </div>
