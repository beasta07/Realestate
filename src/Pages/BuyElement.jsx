        ...
        <div className="sm:flex justify-between sm:px-0 px-1">
          <div>
            ...
            <div className="flex ">
              ...
              <div className="text-[#EB6753] mr-4 divide-y">
          ...
          <div>
            <div className="flex leading-[3rem]">
              <div className="border-2 bg-transparent p-2 ml-12 rounded-md hover:border-black h-9">
                <CiHeart />
              </div>
        ...
        <div className="sm:grid grid-rows-2 grid-flow-col gap-4 mt-[3rem] mb-[4rem] sm:mb-0">
          <div className="row-span-3">
            <img
              ...
              className="rounded-l-xl hover:scale-105 transition-transform duration-300 sm:h-[34.3rem] sm:w-[50rem] object-cover"
            />
          </div>
          <div className="col-span-2">
            <img
              src={`https://api.myraj.au/${property?.images[1]}`}
              className="hidden sm:block rounded-r-xl hover:scale-105 transition-transform duration-300 sm:h-[16.6rem] sm:w-[25rem] object-cover"
            />
          </div>
          <div className=" col-span-2">
            <img
              src={`https://api.myraj.au/${property?.images[2]}`}
              className="hidden sm:block rounded-r-xl hover:scale-105 transition-transform duration-300 sm:h-[16.6rem] sm:w-[25rem] object-cover"
            />
          </div>
        </div>
        ...
        <div className="container w-[100%] mx-auto pb-16">
          <div className="sm:flex p-5">
            <div className="sm:w-[70%] sm:px-3 rounded-xl shadow-md bg-white mt-[2rem] py-6">
              <h1 className="font-semibold p-5 text-[1.3rem]">
            ...
            <div className="py-5 px-3 shadow rounded-lg mt-[2rem] ml-8 bg-white">
              ...
              >
                {({ values, handleChange, handleSubmit, errors, touched }) => (
                  <Form>
                    <h1 className="text-center text-bold text-[1.25rem] mt-4">
                      Inquiry Form
                    </h1>
            ...
            <div className="p-5 pb-3 ">
              ...
              <div className="sm:flex gap-[4rem]">
                <div>
                  ...
                  <button
                      className={`py-3 px-5 bg-blue-800 rounded-lg text-white ${!isUserLoggedIn ? 'cursor-not-allowed' : 'hover:bg-blue-200 hover:text-gray-200'
