        ...
        <div className="w-[100%] bg-[#F6F7F6] py-5">
            <div className="px-4 sm:px-0 container w-full mx-auto sm:flex justify-between mb-[3rem]">
                ...
                <div className="sm:flex mb-9">
                    <button className="mt-4 flex py-3 px-[7.5rem] sm:px-6 rounded-lg border-2 border-black">Contact Us<MdOutlineArrowOutward className="mt-1 ml-2"/></button>
                    <button className="mt-4 flex py-3 px-[7.1rem] sm:px-6 rounded-lg border-2 border-black bg-black text-white sm:ml-5"><MdOutlineLocalPhone className="mt-1 mr-2"/>980-5236415</button>
                </div>
            </div>
        </div>
    </div>
